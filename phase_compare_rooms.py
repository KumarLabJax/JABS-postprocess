...
def run_analysis(args):
    ...
    fig.add_trace(go.Scatterpolar(
        name = BEHAVIOR1 + ' B2B', 
        r = b6_df1[b6_df1['room'] == 'B2B']['r'],
        theta = b6_df1[b6_df1['room'] == 'B2B']['peak_phase'], 
        thetaunit = 'radians',
        mode = 'markers',
    ...
    fig.add_trace(go.Scatterpolar(
        name = BEHAVIOR1 + ' B6', 
        r = b6_df1[b6_df1['room'] == 'B6']['r'],
        theta = b6_df1[b6_df1['room'] == 'B6']['peak_phase'],
        thetaunit = 'radians',
        mode = 'markers',
        marker = dict(color = BLUE)
    ), 1, 1)
    fig.add_trace(go.Scatterpolar(
        name = BEHAVIOR1 + ' CBAX2B', 
        r = b6_df1[b6_df1['room'] == 'CBAX2B']['r'],
        theta = b6_df1[b6_df1['room'] == 'CBAX2B']['peak_phase'], 
        thetaunit = 'radians',
        mode = 'markers',
    ...
    fig.add_trace(go.Scatterpolar(
        r = btbr_df1[btbr_df1['room'] == 'B2B']['r'],
        theta = btbr_df1[btbr_df1['room'] == 'B2B']['peak_phase'],
        thetaunit = 'radians',
        mode = 'markers', 
        marker = dict(color = RED),
        showlegend=False
    ...
    fig.add_trace(go.Scatterpolar(
        r = btbr_df1[btbr_df1['room'] == 'B6']['r'],
        theta = btbr_df1[btbr_df1['room'] == 'B6']['peak_phase'],
        thetaunit = 'radians',
        mode = 'markers', 
        marker = dict(color = BLUE),
        showlegend=False
    ...
    fig.add_trace(go.Scatterpolar(
        r = btbr_df1[btbr_df1['room'] == 'CBAX2B']['r'],
        theta = btbr_df1[btbr_df1['room'] == 'CBAX2B']['peak_phase'],
        thetaunit = 'radians',
        mode = 'markers', 
        marker = dict(color = GREEN),
        showlegend=False
    ...
    fig.add_trace(go.Scatterpolar(
        name = BEHAVIOR2 + ' B2B', 
        r = b6_df2[b6_df2['room'] == 'B2B']['r'],
        theta = b6_df2[b6_df2['room'] == 'B2B']['peak_phase'], 
        thetaunit = 'radians',
        mode = 'markers',
        marker = dict(color = RED)
    ), 1, 1)
    fig.add_trace(go.Scatterpolar(
        name = BEHAVIOR2 + ' B6', 
        r = b6_df2[b6_df2['room'] == 'B6']['r'],
        theta = b6_df2[b6_df2['room'] == 'B6']['peak_phase'],
        thetaunit = 'radians',
        mode = 'markers',
        marker = dict(color = BLUE)
    ), 1, 1)
    fig.add_trace(go.Scatterpolar(
        name = BEHAVIOR2 + ' CBAX2B', 
        r = b6_df2[b6_df2['room'] == 'CBAX2B']['r'],
        theta = b6_df2[b6_df2['room'] == 'CBAX2B']['peak_phase'], 
        thetaunit = 'radians',
        mode = 'markers',
        marker = dict(color = GREEN)
    ), 1, 1)
    ...
    fig.add_trace(go.Scatterpolar(
        r = btbr_df2[btbr_df2['room'] == 'B2B']['r'],
        theta = btbr_df2[btbr_df2['room'] == 'B2B']['peak_phase'], 
        thetaunit = 'radians',
        mode = 'markers',
        marker = dict(color = RED),
        showlegend=False
    ...
    fig.add_trace(go.Scatterpolar(
        r = btbr_df2[btbr_df2['room'] == 'B6']['r'],
        theta = btbr_df2[btbr_df2['room'] == 'B6']['peak_phase'],
        thetaunit = 'radians',
        mode = 'markers',
        marker = dict(color = BLUE),
        showlegend=False
    ...
    fig.add_trace(go.Scatterpolar(
        r = btbr_df2[btbr_df2['room'] == 'CBAX2B']['r'],
        theta = btbr_df2[btbr_df2['room'] == 'CBAX2B']['peak_phase'], 
        thetaunit = 'radians',
        mode = 'markers',
        marker = dict(color = GREEN),
        showlegend=False
    ...
    fig.write_image('raleigh_plot_room_comp.png')
    ...
    fig3.add_trace(go.Scatterpolar(
        name = 'B2B', 
        r = b6_df[b6_df['room'] == 'B2B']['r'],
        theta = b6_df[b6_df['room'] == 'B2B']['phase_diff'], 
        thetaunit = 'radians',
        mode = 'markers',
        marker = dict(color = RED)
    ), 1, 1)
    fig3.add_trace(go.Scatterpolar(
        name = 'B6', 
        r = b6_df[b6_df['room'] == 'B6']['r'],
        theta = b6_df[b6_df['room'] == 'B6']['phase_diff'], 
        thetaunit = 'radians',
        mode = 'markers',
        marker = dict(color = BLUE)
    ), 1, 1)
    fig3.add_trace(go.Scatterpolar(
        name = 'CBAX2B', 
        r = b6_df[b6_df['room'] == 'CBAX2B']['r'],
        theta = b6_df[b6_df['room'] == 'CBAX2B']['phase_diff'], 
        thetaunit = 'radians',
        mode = 'markers',
        marker = dict(color = GREEN)
    ), 1, 1)
    ...
    fig3.add_trace(go.Scatterpolar(
        ...
        r = btbr_df[btbr_df['room'] == 'B2B']['r'],
        theta = btbr_df[btbr_df['room'] == 'B2B']['phase_diff'],
        thetaunit = 'radians',
        mode = 'markers', 
        marker = dict(color = RED),
        showlegend=False
    ...
    fig3.add_trace(go.Scatterpolar(
        name = "BTBR T<+> ltpr3<tf>/J",
        r = btbr_df[btbr_df['room'] == 'B6']['r'],
        theta = btbr_df[btbr_df['room'] == 'B6']['phase_diff'],
        thetaunit = 'radians',
        mode = 'markers', 
        marker = dict(color = BLUE),
        showlegend=False
    ...
    fig3.add_trace(go.Scatterpolar(
        name = "BTBR T<+> ltpr3<tf>/J",
        r = btbr_df[btbr_df['room'] == 'CBAX2B']['r'],
        theta = btbr_df[btbr_df['room'] == 'CBAX2B']['phase_diff'],
        thetaunit = 'radians',
        mode = 'markers', 
        marker = dict(color = GREEN),
        showlegend=False
    ...
    fig3.write_image('raleigh_plot_diff_room_comp.png')
